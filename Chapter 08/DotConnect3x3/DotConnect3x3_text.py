#  File:   DotConnect3x3.py
#  Author: Rick Halterman
#  Date:   9/30/2014 11:19:58 AM
...
#def make_line(dot1, dot2):
#    '''  Determines the line between two dots.
#         dot1 and dot2 represent the dots in the pattern
#             0---1---2
#             |   |   |
#             3---4---5
#             |   |   |
