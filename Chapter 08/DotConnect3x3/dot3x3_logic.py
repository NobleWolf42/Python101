...
name (a string) as shown here:
       ...
       @---1---@---2---@      1 = 'Northwest_North'
       |       |       |      2 = 'North_Northeast'
       3       4       5      3 = 'Northwest_West'
       |       |       |      4 = 'North_Center'
       @---6---@---7---@      5 = 'Northeast_East'
       |       |       |      6 = 'West_Center'
       8       9      10      7 = 'Center_East'
       |       |       |      8 = 'West_Southwest'
       @---11--@---12--@      9 = 'Center_South'
                             10 = 'East_Southeast'
                             11 = 'Southwest_South'
                             12 = 'South_Southeast'
...
#        return _lefttop_owner != None
#    elif line == 'North_Northeast': 
#        return _righttop_owner != None
#    elif line == 'Northwest_West': 
#        return _lefttop_owner != None
#    elif line == 'North_Center': 
#        return _lefttop_owner != None or _righttop_owner != None
#    elif line == 'Northeast_East': 
#        return _righttop_owner != None
#    elif line == 'West_Center': 
#        return _lefttop_owner != None or _leftbottom_owner != None
#    elif line == 'Center_East': 
#        return _righttop_owner != None or _rightbottom_owner != None
#    elif line == 'West_Southwest': 
#        return _leftbottom_owner != None
#    elif line == 'Center_South': 
#        return _leftbottom_owner != None or _rightbottom_owner != None
#    elif line == 'East_Southeast': 
#        return _rightbottom_owner != None
